...
from core_orchestration.organization_mcp import OrganizationMCP, organization_context
from core_orchestration.practitioner_role_mcp import PractitionerRoleMCP, practitioner_role_context
...
def mcp_practitioner_role_context(req: QueryRequest):
    return {"result": practitioner_role_context(req.query)}
